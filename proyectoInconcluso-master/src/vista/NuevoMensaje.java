...
public class NuevoMensaje extends javax.swing.JFrame {
    ...
    public NuevoMensaje() {
        initComponents();
        EnvioController envo = new EnvioController(this);
        enviarButton.addActionListener(envo);
        enviarButton.setActionCommand("ingresar");
        UsuarioDAO userdao = new UsuarioDAO();
        
        ArrayList<Usuario> user = userdao.getUsuarios();
        
        for (int i = 0; i < user.size(); i++) {
            destinatarioCB.addItem(user.get(i).getNombre());
        }      
    ...
    private void initComponents() {
        ...
        destinatarioCB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                destinatarioCBActionPerformed(evt);
            }
        });
    ...
    private void destinatarioCBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_destinatarioCBActionPerformed
        
    }//GEN-LAST:event_destinatarioCBActionPerformed
