...
public class BandejaEntrada extends javax.swing.JFrame {
    ...
    public BandejaEntrada(int idUsuarioLogueado) {
        ...
        BandejaController bdja = new BandejaController(this);
        jButton1.addActionListener(bdja);
        jButton1.setActionCommand("Nuevo Mensaje");
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        String[] contenido = null;

        MensajeDAO msj = new MensajeDAO();
        ArrayList<Mensaje> msjs = msj.getMensajes();
        UsuarioDAO user = new UsuarioDAO();


        
        /*for (int i = 0; i < msjs.size(); i++) {
            contenido[i] = msjs.get(i).getContenido();
            
            dtm.addRow(contenido);
        }*/
